...
def add_maskdino_config(cfg):
    ...
    cfg.MODEL.MaskDINO.OBOX_LOSS = False
    ...
    cfg.MODEL.MaskDINO.DN_AUG=False
    ...
    # 在获取maks时加入位置信息
    cfg.MODEL.SEM_SEG_HEAD.WITH_POSITION = False
    cfg.MODEL.SEM_SEG_HEAD.NEW_POS = False
    # LSJ aug
    cfg.INPUT.IMAGE_SIZE = 1024
    cfg.INPUT.MIN_SCALE = 0.1
    cfg.INPUT.MAX_SCALE = 2.0
    cfg.INPUT.LIVE_CELL = False
    # point loss configs
    # Number of points sampled during training for a mask point head.
    cfg.MODEL.MaskDINO.TRAIN_NUM_POINTS = 112 * 112
    cfg.MODEL.MaskDINO.TRAIN_GT_POINTS = 0
    ...
    cfg.SUBMIT = False  #是否便译成可提交的可执行程序
    cfg.SUBMIT_DIR = ""
