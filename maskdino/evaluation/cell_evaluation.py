...
class CellbboxEvaluator(COCOEvaluator):
    """
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            if "instances" in output:
                ...
                prediction["instances"] = instances_to_coco_json(instances, input["image_id"], thresdhold=0.01)
...
def instances_to_coco_json(instances, img_id, thresdhold=0.01):
    """
