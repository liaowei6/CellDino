        ...
        if "annotations" in dataset_dict:
            ...
            for obj in dataset_dict.pop("annotations"):
                if obj["first"]:
                    ...
                    annos_second.append(transform_instance_annotations(obj, transforms, image_shape, parent_dir,crop=self.is_crop))
...
def transform_instance_annotations(
    annotation, transforms, image_size, parent_path, keypoint_hflip_indices=None, crop = False
):
    """
